...
<body>
	...
	<div class="container_signup_signin" id="container_signup_signin">
		<div class="form-container sign-up-container">
			<form name="sign-up-form" action="connect.php" method="post" onsubmit="return signUpValidateForm()">
				...
				<input class="signupname" name="sign-up-name" type="text" placeholder="Name" />
				<input class="signupemail" name="sign-up-email" type="email" placeholder="Email" />
				<input class="signuppasswd" name="sign-up-passwd" type="password" placeholder="Password" />
				<button>Sign Up</button>
			</form>
		</div>
		<div class="form-container sign-in-container">
			<form name="sign-in-form" style="color: var(--theme-title);" action="connect.php" method="post"
